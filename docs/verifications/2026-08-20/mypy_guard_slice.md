...
## 조건 폐쇄 — **B1·H1 둘 다 닫힘 (2026-08-20, 구현 세션 `4bd1a3d`)**
...
- ~~**B1 조건 폐쇄 대기**~~ — **닫혔다(2026-08-20 `4bd1a3d`)**. 위 §조건 폐쇄 참조. 셀 1개 확장이 아니라 **셀 1개 확장 + 신규 셀 1개**가 됐다(주석 축과 설정 축이 다른 검사라 한 셀에 묶으면 무엇이 깨졌는지 안 보인다). **H1(M11)도 같은 셀로 함께 닫혔다.**
