...
| 판정 | 건수 | 뜻 |
|---|---|---|
| 합격 | 181 | blocking 결함 없음 |
| **조건부 합격** | **71** | 합격이되 닫아야 할 조건이 있었다 |
