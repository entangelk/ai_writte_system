...
| 판정 | 건수 | 뜻 |
|---|---|---|
| 합격 | 201 | blocking 결함 없음 |
| **조건부 합격** | **98** | 합격이되 닫아야 할 조건이 있었다 |
| **불합격** | **5** | 핵심 계약 위반으로 다음 슬라이스 진행이 차단됐다 |

**조건부 합격이 32%**라는 것이 이 절차가 형식이 아니라는 증거다. 검증이 실제로 지적을 냈고,
