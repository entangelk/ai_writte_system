...
구현 진행: SoT v1.6.99에서 Product shell A, v1.7.1~v1.7.5에서 Writing C와 Review Inbox B를 완료했다. 2026-07-18 dogfood 뒤 SoT v1.7.9에서 Writing Workspace V2 방향을 확정하고 v1.7.10 W0 exact contract/migration/schema, v1.7.11 W1 editor+docked right rail/source deep-link를 완료했다. W1 독립 검증의 dirty cross-Draft 데이터 손실과 회귀 empty cell은 v1.7.12에서 closure했다. 다음은 W2 ProjectBrief onboarding+canonical overview다. 전체 Product shell 수용 기준이 남아 본 문서 상태는 `Draft`를 유지한다.
...
- [x] 프로젝트 전체 export 조립: 비보관 unit의 ordered latest TXT/Markdown + 별도 manifest. saved publication manifest는 보류(SoT v1.7.9)
...
- [`../live_review_briefs/2026-07-18/writing_workspace_ux_restructure.md`](../live_review_briefs/2026-07-18/writing_workspace_ux_restructure.md)
