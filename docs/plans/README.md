...
> **브리프를 찾고 있다면 아래 "전체 인덱스"에서 트랙으로 좁힌다.** 이 디렉터리의 대다수(107개 중 89개)는
...
| [`embedding-adapter-slice-decisions.md`](embedding-adapter-slice-decisions.md) | **다음 슬라이스** — OpenAI 형식 어댑터 자리·배치·차원 전환·조립 누락 방지 | **오너 결정 대기**(2026-08-18 작성) |
