...
| [`08-2-usage-ledger-decisions.md`](08-2-usage-ledger-decisions.md) | 8.2 — 사용량 원장(행 필드와 삭제 내성·중복 방지 키·집계 정본·보존 기간·관리자 조정 표현·**프로젝트 이름 이력**·**5초 DB 잠금**) | L1~L5 확정 / **L6·L7 대기** |
