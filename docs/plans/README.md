...
| [`final-save-analysis-decisions.md`](final-save-analysis-decisions.md) | Scene 최종 저장 1회·분석 연동·후속 수정 상태 | **Resolved(2026-09-01)** — D1~D3=B · D4=A(서버 동기 실행) · 최신 snapshot 미분석은 작업실에서도 `분석 필요` |
