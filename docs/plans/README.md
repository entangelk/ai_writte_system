...
> **브리프를 찾고 있다면 아래 "전체 인덱스"에서 트랙으로 좁힌다.** 이 디렉터리의 대다수(103개 중 85개)는
...
| [`09-1-activity-timeline-screen-decisions.md`](09-1-activity-timeline-screen-decisions.md) | 9.1 — 활동 타임라인 **화면** 착수 결정(화면의 자리 · **최신 100건 상한** · 행위자 표시 · 라벨 정본 · **replay 중복** · target 링크) | **Open(2026-08-10)** — S1~S6 오너 결정 대기 · backend 변경 0줄이 목표 |
