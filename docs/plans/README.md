...
> **브리프를 찾고 있다면 아래 "전체 인덱스"에서 트랙으로 좁힌다.** 이 디렉터리의 대다수(119개 중 99개)는
...
| [`contract-schema-duplication-audit-decisions.md`](contract-schema-duplication-audit-decisions.md) | 8개 LLM 호출부의 에코/결정적 필드/호출 분산 전수조사 | 확정 - 구현 대기 |
