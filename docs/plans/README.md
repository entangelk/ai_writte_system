...
| [`08-1-request-quota-policy-decisions.md`](08-1-request-quota-policy-decisions.md) | 8.1 — 한도 저장 계약(저장 위치·기간 종류와 경계 시각·기간 파생/저장·기본과 override·무제한/정지 표현·변경 효력·기본 한도 값) | Decision needed |
