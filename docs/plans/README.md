...
> **브리프를 찾고 있다면 아래 "전체 인덱스"에서 트랙으로 좁힌다.** 이 디렉터리의 대다수(140개 중 118개)는
...
| [`slice5-withdrawal-cancel-after-purge-claim-decisions.md`](slice5-withdrawal-cancel-after-purge-claim-decisions.md) | 계정 탈퇴 — **파기가 청구된 뒤의 취소**를 거부할지, 거부하면 어떤 얼굴로 답할지(D5 가 정하지 않은 구간) | **Resolved** — ⓐ 기존 409 에 합류(오너 2026-09-13) · 시행 완료 |
...
| [`activity-log-replay-and-partial-decisions.md`](activity-log-replay-and-partial-decisions.md) | 활동 로그 — 재전송·idempotent replay·부분 실패가 행을 남기는가(결정 셋) | **Resolved** — D1=ⓑ · D2=ⓑ(오너 2026-09-13) · D3=ⓐ(오너 2026-09-08) |
