...
> **브리프를 찾고 있다면 아래 "전체 인덱스"에서 트랙으로 좁힌다.** 이 디렉터리의 대다수(95개 중 78개)는
...
| [`08-2b-duplicate-request-lock-decisions.md`](08-2b-duplicate-request-lock-decisions.md) | 8.2b — 실수 중복 요청의 **DB 잠금**(L7: 잠금 수명·키 축·원자적 차지·확인 통과·실패 반환·에러 통로/상태코드) | **Resolved** — G1=C·G2~G6=A, 구현 완료(v1.7.86) |
