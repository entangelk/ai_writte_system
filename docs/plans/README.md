...
> **브리프를 찾고 있다면 아래 "전체 인덱스"에서 트랙으로 좁힌다.** 이 디렉터리의 대다수(97개 중 80개)는
...
| [`08-4-product-wiring-decisions.md`](08-4-product-wiring-decisions.md) | 8.4 — 제품 경로 배선(관리자·내부 **면제** 여부·402/429/403 프론트 계약·**확인 대화 UX**·확인 헤더 층·**잔여 표시 API**·프론트 안정 키·유료 화면 전수 가드) | **Awaiting owner decision** — W1~W7 |
