...
| [`account-withdrawal-implementation-phases.md`](account-withdrawal-implementation-phases.md) | 계정 탈퇴 구현 순서(셀프 요청 · 30일 유예 · 취소 · 파기 데몬) | **Proposed** — Slice 0~5 미착수, D1~D6 오너 결정 선행 |
