...
>
> **★ 오너 결정이 2026-09-08 에 전부 끝났다 — 착수 가능한 순서**(브리프 7건, 위 "열린 것" 표가 답을 요약한다). **막고 있던 것이 없다**: 계정 탈퇴는 Slice 3부터 이어가고, 10·12번은 약관 값 넷이 왔다.
>
> | 순서 | 무엇 | 왜 이 순서인가 |
> |---|---|---|
> | **1** | **11번 계정 탈퇴 Slice 3~5** | Slice 2까지 닫혔다. 다음은 파기 데몬이며 기존 `execute_project_purge` 재사용·부분 파기 fail-stop·원장 보존이 핵심이다 |
