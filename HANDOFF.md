...
2. 전체 배포형 E2E가 필요하면 application/gateway 프로세스를 실제 네트워크로 띄우고 source_ref HTTP 준비 → analysis run을 확인한다. 현재 live smoke는 ASGITransport로 Application/Gateway app을 같은 프로세스 안에 조립한다.
