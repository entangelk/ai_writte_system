...
2. Phase 3A 다음 작은 slice: source block indexing service를 Application HTTP API로 노출할지, 또는 persistent Chroma-like adapter를 먼저 붙일지 결정한다. 현재 public 표면은 CLI script뿐이고 HTTP endpoint는 없다.
