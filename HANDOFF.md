...
> | 순서 | 무엇 | 왜 이 순서인가 |
> |---|---|---|
> | **1** | **11번 계정 탈퇴 Slice 3~5** | Slice 2까지 닫혔다. **Slice 3 은 ⓑ+ⓔ 로 확정**([브리프](docs/plans/slice3-withdrawal-purge-daemon-decisions.md), 2026-09-09) — 데몬 + 사용자 축 reconciler 스크립트가 범위이고 관리자 화면은 Slice 4 다 |
