...
정본은 [`docs/system-contract-sot.md`](docs/system-contract-sot.md) **v1.8.57**(Approved). **미확정 항목은 추측 구현하지 않는다.** 아래는 코드를 만지기 전에 알아야 하는 요약이다.
