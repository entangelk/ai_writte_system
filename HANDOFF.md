...
0. **★ Phase S — 보안 감사 후속**(기록 [`security_audit_dual_workflow.md`](docs/verifications/2026-09-05/security_audit_dual_workflow.md), 확정 39건 · critical 0 · HIGH 1). 아래 "🛡 보안 — Phase S" 표가 항목별 정본이다. **S-3 signup 레이트리밋(오늘 열려 있다) → S-1 quota dedupe(가입 열기 전 필수) → S-0 문서 스윕 → 나머지는 트리거.**
