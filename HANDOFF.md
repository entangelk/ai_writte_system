...
정본은 [`docs/system-contract-sot.md`](docs/system-contract-sot.md) **v1.8.62**(Approved). **미확정 항목은 추측 구현하지 않는다.** 아래는 코드를 만지기 전에 알아야 하는 요약이다.
...
> | — | ~~11번 Slice 4b~~(관리자 잔여 정리) | **완료(2026-09-12, SoT v1.8.62)** — 브리프 [`slice4b-admin-residual-purge-decisions.md`](docs/plans/slice4b-admin-residual-purge-decisions.md), 오너 결정 ①ⓐ·②ⓐ·③ⓐ. **독립 검증 진행 중(아래 11번)** |
>
