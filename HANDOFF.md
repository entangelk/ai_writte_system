...
- Git repository이며 현재 기준 구현 commit은 `c87fec3`이다.
...
- 실제 HTTP adapter 전까지 live 확인은 direct curl smoke로만 구분한다.

## Next Tasks

1. F1/F2 보강 후속 검증: `docs/verification_briefs/2026-06-24/llm_gateway_f1_f2_live_smoke.md`
2. 검증 AI가 조건 폐쇄와 direct live smoke를 확인한 뒤 verdict 승격 여부 결정
3. Slice 0.6 실제 HTTP adapter의 dependency/package 경계 확정
4. flat loop decision/tool/budget 계약 확정
...
- direct live smoke: health ok, model QAT GGUF Q4_0/context 8192, non-thinking 한국어 completion 성공. 실제 HTTP adapter 경유 smoke는 아님
