...
2. Phase 3A 다음 작은 slice: persistent Chroma-like adapter를 붙일지, HTTP/script rebuild를 live-Mongo smoke로 검증할지 결정한다. 현재 public 표면은 CLI script와 HTTP rebuild endpoint이며 둘 다 deterministic fake vector adapter를 사용한다.
