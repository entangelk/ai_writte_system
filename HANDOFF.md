...
2. Phase 2A HTTP 상태/결과 노출 API는 완료됐다. `docs/plans/02-analysis-runner-execution-decisions.md` 사용자 승인 필요. 특히 run endpoint 도입 여부, 동기 실행 여부, replay 의미, runner dependency 주입 방식, 실패 HTTP status/error envelope를 확정해야 구현 가능하다.
