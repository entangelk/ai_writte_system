...
- 정본은 `docs/system-contract-sot.md` **v1.7.67**(Approved). 미확정 항목은 추측 구현하지 않는다.
...
2. **R-a 적용 지점은 전부 채워졌고(SoT v1.7.66) K-4(프론트 글자수 카운터+소프트 경고, v1.7.67, 오너 결정 "서버 예산 노출까지")도 닫혔다 — 남은 것은 알파 R-c 관측 1회뿐.** 오너 결정(2026-07-31)은 **(ii) 창에서 유도 + (iii) 후보 길이에서 유도**, **(i) 상수는 기각**.
