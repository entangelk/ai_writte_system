...
정본은 [`docs/system-contract-sot.md`](docs/system-contract-sot.md) **v1.8.59**(Approved). **미확정 항목은 추측 구현하지 않는다.** 아래는 코드를 만지기 전에 알아야 하는 요약이다.
...
> | 3 | 11번 **Slice 5**(정책 §8 → §6 승격) | **다른 작업 AI가 진행 중(2026-09-12)** — 이 트리에서 그들의 커밋 위에 얹는다 |
