...
async def execute_project_purge(
    *,
    ...
    D8-6d 원 주석: 영구 파기(불가역). archive(soft)와 달리 23컬렉션(v1.8.11
    `scene_notes` 합류 19 + 2026-09-02 identity group 3 + v1.8.29
    `candidate_identity_group_approvals`)을 hard delete 하고
