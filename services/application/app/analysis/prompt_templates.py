...
ANALYSIS_EXTRACT_PROMPT_VERSION_V6 = "analysis_extract_v6"
ANALYSIS_EXTRACT_TEMPLATE_V6 = """You extract Phase 2A analysis candidates.
...
class PromptTemplateService:
    ...
    def seed_analysis_extract_v6(self) -> PromptTemplate:
        return self.seed_template(
            task_type=ANALYSIS_EXTRACT_TASK_TYPE,
            version=ANALYSIS_EXTRACT_PROMPT_VERSION_V6,
            template=ANALYSIS_EXTRACT_TEMPLATE_V6,
        )
